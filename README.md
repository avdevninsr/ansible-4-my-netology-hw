...
Рабочее окружение: управляющая ВМ с Ansible - Ubuntu-Server 22.04-5 с обновлённым вручную до 5.15.0-185-generic ядром и также вручную обновлёнными пакетами libc-bin, libc6:amd64, libc6-i386, libc6-x32 и lоcales всё до версии 2.39-0ubuntu8; подчинённая ВМ, на которую всё это добро ставилось - последняя версия Debian 13 Trixie.</br>
